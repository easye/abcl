...
\paragraph{}
\label{EXTENSIONS:LINE-LENGTH}
\index{LINE-LENGTH}
--- Function: \textbf{line-length} [\textbf{extensions}] \textit{stream}
...
\paragraph{}
\label{EXTENSIONS:REGISTER-ASDF}
\index{REGISTER-ASDF}
--- Function: \textbf{register-asdf} [\textbf{extensions}] \textit{asdf-file-or-files}

...
\begin{adjustwidth}{5em}{5em}
Retrieves or modifies a public field in a Java class or instance.
...
\begin{adjustwidth}{5em}{5em}
Retrieves or modifies a public field in a Java class or instance without
...
\begin{adjustwidth}{5em}{5em}
Returns a proxy Java object implementing the provided interface(s) using methods implemented in Lisp
...
\paragraph{}
\label{JAVA:LIST-FROM-JARRAY}
\index{LIST-FROM-JARRAY}
--- Function: \textbf{list-from-jarray} [\textbf{java}] \textit{jarray}
...
\paragraph{}
\label{JAVA:LIST-FROM-JENUMERATION}
\index{LIST-FROM-JENUMERATION}
--- Function: \textbf{list-from-jenumeration} [\textbf{java}] \textit{jenumeration}
...
\paragraph{}
\label{JAVA:VECTOR-FROM-JARRAY}
\index{VECTOR-FROM-JARRAY}
--- Function: \textbf{vector-from-jarray} [\textbf{java}] \textit{jarray}
